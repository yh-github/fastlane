...
5. **`technical`**: Bridges the gap between manual labor and engineering. The Assembly Worker pays modest wages ($8) but builds Skill_Tech, making it the strategic gateway to high-paying factory engineering and electronics careers.
